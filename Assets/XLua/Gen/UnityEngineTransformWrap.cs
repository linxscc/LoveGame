...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetProgressBar", _m_GetProgressBar);
        ...
        static int _m_GetText(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.UI.Text gen_ret = gen_to_be_invoked.GetText( _path );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetText!");
        ...
        static int _m_GetButton(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.UI.Button gen_ret = gen_to_be_invoked.GetButton( _path );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetButton!");
        ...
        static int _m_GetRectTransform(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.RectTransform gen_ret = gen_to_be_invoked.GetRectTransform( _path );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        UnityEngine.RectTransform gen_ret = gen_to_be_invoked.GetRectTransform(  );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetRectTransform!");
        ...
        static int _m_GetRawImage(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.UI.RawImage gen_ret = gen_to_be_invoked.GetRawImage( _path );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetRawImage!");
        ...
        static int _m_GetImage(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.UI.Image gen_ret = gen_to_be_invoked.GetImage( _path );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.GetImage!");
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.UI.Toggle gen_ret = gen_to_be_invoked.GetToggle( _path );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetProgressBar(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        game.main.ProgressBar gen_ret = gen_to_be_invoked.GetProgressBar( _path );
                        translator.Push(L, gen_ret);
