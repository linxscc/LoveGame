...
public class SuperStarView : View
{
    ...
    public void Confirm()
    {
        ...
        SendMessage(new Message(MessageConst.CMD_BATTLE_SEND_ROLE_ID, Message.MessageReciverType.DEFAULT, roleIds));
        SendMessage(new Message(MessageConst.CMD_BATTLE_SUPERSTAR_CONFIRM, Message.MessageReciverType.DEFAULT,
            _totalPower, _cards));
    }
