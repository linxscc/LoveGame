...
namespace game.main
{
    public class DialogFrame : MonoBehaviour, IDragHandler
    {
        ...
        [SerializeField] private float _radian = 1f;
        ...
        public void Show(float showDelay)
        {
            ...
            _dialogStr = Util.GetNoBreakingString(_entity.dialog);
            ...
            _coroutine = ClientTimer.Instance.DelayCall(() =>
            {
                _isStart = true;
                ChangeStyle();
                _nameTxt.text = _entity.roleName;
                _nameTxt2.text = _entity.roleName;

                gameObject.SetActive(true);

                if (_entity.shakeDialog)
                {
        ...
        private void ChangeStyle()
        {
            ...
            EntityVo.DialogFrameStyle frameStyleId;
            Enum.TryParse(_entity.id, out frameStyleId);
            ...
            switch (frameStyleId)
            {
                ...
                case EntityVo.DialogFrameStyle.Heroine2:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(frameStyleId), frameStyleId, null);
            }
        }
        ...
        private void SetContentTextWidthByHead()
        {
            ...
            if (string.IsNullOrEmpty(_entity.headId))
            {
                _contentTxtY = 0;
