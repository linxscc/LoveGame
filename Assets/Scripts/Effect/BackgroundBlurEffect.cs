...
namespace Assets.Scripts.Module.Effect
{
    public class BackgroundBlurEffect : MonoBehaviour
    {
        ...
        public void StartRecord(Texture texture, Action<RenderTexture> onRecordTexture)
        {
//            _imageTexture =
//                new RenderTexture((int)rectTransform.sizeDelta.x, (int)rectTransform.sizeDelta.y, 
//                    (int) Screen.dpi, RenderTextureFormat.ARGB32);
//
            _imageTexture = new RenderTexture(Screen.width, Screen.height, 
                    (int) Screen.dpi, RenderTextureFormat.ARGB32);

            _camera = GetComponent<Camera>();
            _camera.targetTexture = _imageTexture;

            RawImage image = transform.GetRawImage("Canvas/RawImage");

            image.texture = texture;

//            image.rectTransform.sizeDelta = rectTransform.sizeDelta;
//            image.rectTransform.anchoredPosition = rectTransform.anchoredPosition;
            
            _onRecordTexture = onRecordTexture;
        ...
        public void SetAnimation(string animation, Action onComplete)
        {
            ...
            if (_animator.runtimeAnimatorController==null)
            {
               _animator.runtimeAnimatorController
                    =ResourceManager.Load<RuntimeAnimatorController>("Story/Prefabs/BlurAnimatorController");
            }
        ...
        //指定Shader名称
        private string ShaderName = "UI_Effect/RapidBlurEffect";
        ...
        private Action<RenderTexture> _onRecordTexture;
        ...
        void Start()
        {
            ...
            {
                enabled = false;
                Debug.LogError("===SystemInfo.supportsImageEffects===不支持屏幕特效");
            }
        }
        ...
        {
            if (_animator == null && (IsStart == false || IsRecord))
                return;
            ...
            if (CurShader != null)
            {
                ...
                _onRecordTexture(_imageTexture);
            }
        ...
        void OnDisable()
        {
            if (_imageTexture)
            {
                ...
                DestroyImmediate(_imageTexture);
            }
